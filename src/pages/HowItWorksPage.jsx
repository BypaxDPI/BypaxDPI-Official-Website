        ...
        <div className="proxy-page">
            ...
            <main className="proxy-page-content">
                <div className="container">
                    ...
                    {/* ===== WHAT DOES IT DO ===== */}
                    <motion.div className="proxy-explain-section" {...fadeUp(0.15)}>
                    ...
                    {/* ===== ATTENTION DEVICES ===== */}
                    <motion.div className="proxy-devices-section" {...fadeUp(0.25)}>
                        <div className="section-header">
                    ...
                    {/* ===== FAQ ===== */}
                    <motion.div className="proxy-faq-section" {...fadeUp(0.3)}>
                        <div className="section-header">
                    ...
                    {/* ===== CTA ===== */}
                    <motion.div className="proxy-cta-section" {...fadeUp(0.35)}>
